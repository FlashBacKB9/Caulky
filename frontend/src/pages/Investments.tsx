        ...
        <>
          ...
          <div className="px-4 py-3">
            <div className="flex items-center gap-3">
              <button onClick={() => setExpanded(e => !e)} className="flex items-center gap-2 flex-1 min-w-0 text-left overflow-hidden">
                ...
                {linkedType && <span className="text-xs text-gray-400 dark:text-gray-500 shrink-0 hidden sm:inline">· {linkedType.name}</span>}
            ...
            {/* mobile-only: gain badge on its own line */}
            {fund.gain_eur != null && fund.gain_pct != null && (
